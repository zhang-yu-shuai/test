  ...
  <div>
   <div class="top">
    ...
    <el-table
      ...
      <el-table-column  prop="img" label="商品图片" width="200" style="height: 80px">
    ...
    <el-dialog title="新建拍卖" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        ...
        <el-form-item label="最高出价人" :label-width="formLabelWidth">
          {{ form.userName }}
        </el-form-item>
...
import { auctionGetOwnerReq, auctionUpdateReq, auctionDeleteReq, auctionAddReq } from '@/api/good.js';
...
export default {
  ...
  methods:{
    fetchList() {
      auctionGetOwnerReq(this.currentPage - 1, this.currentPageSize).then(response => {
